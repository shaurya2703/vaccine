    ...
    return Scaffold(
      ...
      body: GridView(
        ...
        children: <Widget>[
          ...
          _buildCard("Upcoming Appointments", FontAwesomeIcons.ambulance, Colors.teal, onTap: (){Navigator.of(context).pushNamed("ambulance");}),
          _buildCard("Nearest Immunization Center", Icons.local_hospital, Colors.blue, onTap: (){Navigator.of(context).pushNamed("home");}),
          ...
          _buildCard("Recommend A doctor", Icons.chat, Colors.indigo, onTap: (){Navigator.of(context).pushNamed("support");}),
        ],
      ),
    );
  }
