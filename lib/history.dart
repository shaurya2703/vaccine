      ...
      body: Column(
        children: <Widget>[
          Padding(
            ...
            child: Text("Immunization  History", style: TextStyle(fontSize: 22.0,),),
          ),
          _buildMedicalHistoryCard(hospitalName: "ABC Hospital", appointmentDate: "19/02/18", medicalNote: "Mild Fever and Cold"),
          _buildMedicalHistoryCard(hospitalName: "XYZ Hospital", appointmentDate: "19/02/18", medicalNote: "Dengue Fever detected. Low platelet count. Medicines include: ABC, XYZ"),
          _buildMedicalHistoryCard(hospitalName: "PQR Hospital", appointmentDate: "19/02/18", medicalNote: "Mild Fever and Cold"),
        ],
      ),
    );
  }
