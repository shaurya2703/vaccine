...
import 'package:healthy_wealthy/childForm.dart';
import 'package:healthy_wealthy/childList.dart';
...
import 'package:healthy_wealthy/signUp.dart';
...
void main() {
  runApp(MaterialApp(
    ...
    routes: {
      ...
      'child' : (context) => ChildAddPage(),
      'childform':(context)=>ChildForm()
    },
  ));
}
